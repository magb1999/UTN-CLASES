...
*************************************************************************************************
{
    ...
    console.log(nombre)
    {
        nombre = 'pedro'                            reasignando 
        console.log(nombre)
        {
            nombre = 'ramon'                        reasignando
            console.log(nombre)
        }
        console.log(nombre)
    }
    nombre = 'messi'                                reasignando
    console.log(nombre)
}

nombre = 'julieta'                                  reasignando
console.log(nombre) */
/*                                                          
/*************************************************************************************************** */
//BUCLE
...
/* **************************************************************************************************
Vamos a solcitar al usuario 3 numeros y luego voy a sumarlos entre si y
al finalizar debere mostrar por alerta el resultado 
*/
/* 
FOR 
